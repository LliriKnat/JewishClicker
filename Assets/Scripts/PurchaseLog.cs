...
public class PurchaseLog : MonoBehaviour
{
    ...
    public void BuyGoy ()
    {
        ...
        if ((compare == '>') || (compare == '='))
        {
            ...
            GlobalUpgrades.goyCost.multiply(2);
    ...
    public void BuyMoneylander()
    {
        ...
        if ((compare == '>') || (compare == '='))
        {
            ...
            GlobalUpgrades.moneylanderCost.multiply(2);
    ...
    public void BuyRabbi()
    {
        ...
        if ((compare == '>') || (compare == '='))
        {
            ...
            GlobalUpgrades.rabbiCost.multiply(2);
    ...
    public void BuySynagogue()
    {
        ...
        if ((compare == '>') || (compare == '='))
        {
            ...
            GlobalUpgrades.synagogueCost.multiply(2);
    ...
    public void BuyJewerly()
    {
        ...
        if ((compare == '>') || (compare == '='))
        {
            ...
            GlobalUpgrades.jewerlyCost.multiply(2);
    ...
    public void BuyKibbutz()
    {
        ...
        if ((compare == '>') || (compare == '='))
        {
            ...
            GlobalUpgrades.kibbutzCost.multiply(2);
